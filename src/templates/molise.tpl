...
<head>
    ...
    <title>404 - il Molise non esiste</title>
    <link rel="stylesheet" href="css/style.css" type="text/css" />
    <link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico">
</head>
<body>
    <header class="cntcenter">
        <div class="cntcenter huge">404</div>
        <!-- <div class="clear"></div> -->
        <div class="cntcenter"><img src="images/molise.png" alt="Molise" /></div>
        <!-- <div class="clear"></div> -->
